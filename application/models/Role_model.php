...
class Role_model extends CI_Model
{
  ...
  public function create()
  {
    ...
    {
      notify("Gagal", "Terjadi kendala disaat membuat hak akses : ".$ex->getMessage(), "danger", "fa fa-times", null);
    }
  }
  public function read()
  {
    ...
    {
      notify("Gagal", "Terjadi kendala disaat memuat hak akses : ".$ex->getMessage(), "danger", "fa fa-times", null);
    }
    finally
    {
  ...
  public function update()
  {
    ...
    {
      notify("Gagal", "Terjadi kendala disaat update hak akses : ".$ex->getMessage(), "danger", "fa fa-times", null);
    }
  }
  ...
  public function recover()
  {
    ...
    {
      notify("Gagal", "Terjadi kendala disaat memulihkan hak akses : ".$ex->getMessage(), "danger", "fa fa-times", null);
    }
  }
  ...
  public function delete()
  {
    try
    {
      ...
      {
        return http_response_code(401, "Tidak diijinkan");
      }
    }
    catch (Exception $ex)
    {
