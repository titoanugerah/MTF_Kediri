<div class="panel-header bg-primary-gradient">
  <div class="page-inner py-5">
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
      <div>
        <h2 class="text-white pb-2 fw-bold" >Kelola Konten Produk</h2>
      </div>
      <div class="ml-md-auto py-2 py-md-0">
        <a href="#" class="btn btn-white btn-border btn-round mr-2" hidden>Manage</a>
        <div class="form-group">
          <select class="form-control select2modal" id="productId" style="width:150px;">

          </select>

          <button id="btnDelete" class="btn btn-danger btn-sm" onclick="deleteProduct()"><i class="fas fa-trash"></i> Hapus</button>
          <button id="btnAdd" class="btn btn-success btn-sm" onclick="createProduct()"><i class="fas fa-plus"></i> Tambah</button>
        </div>
