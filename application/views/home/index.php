...
<section id="program" >
  <div class="container">
    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <?php $firstPage = 1; foreach($program as $program) : ?>
    <div class="carousel-item <?php if($firstPage==1){echo "active"; $firstPage=0; }?>">
      <a href="<?php echo base_url('page/'.$program->id); ?>">
        <img class="d-block w-100" src="<?php echo base_url('./assets/picture/'.$program->image); ?>">
      </a>
    </div>
    <?php endforeach; ?>
  </div>
...
<section id="wira" class="contact">
  <div class="container">
    ...
    <div class="row justify-content-between">
      <div class="col-lg-5 d-flex align-items-center justify-content-center about-img">
          <!-- <img src="<?php //echo base_url('./assets/template/frontend/'); ?>assets/img/about-img.svg" class="img-fluid" alt="" data-aos="zoom-in"> -->
          <img src="<?php echo base_url('./assets/picture/'.$wira->image); ?>" class="img-fluid" alt="" data-aos="zoom-in">
      </div>

      <div class="col-lg-6 pt-5 pt-lg-0">
        <p data-aos="fade-up" data-aos-delay="100">
        <?php echo $wira->description; ?>
        </p>
      </div>
    </div>
