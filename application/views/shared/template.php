...
<html lang="en">
	<head>
		...
		<title><?php echo $this->config->item('site_name').' | '.$viewName; ?></title>
			...
			<div class="main-header">
				<div class="logo-header" data-background-color="blue">
					<a href="<?php echo base_url(''); ?>" class="logo" style="color:white;">
						<?php echo $this->config->item('site_full_name'); ?> 
					</a>
				...
				<div class="sidebar-wrapper scrollbar scrollbar-inner">
					<div class="sidebar-content">
						...
						<ul class="nav nav-primary">
							<?php if($this->session->userdata('isLogin')){$this->load->view('shared/menu/'.$this->session->userdata('role'));} ?>
						</ul>
					</div>
				</div>
			</div>
